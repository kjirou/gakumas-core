...
export const playCard = (
  ...
  // 3-b. Pアイテムに起因する、スキルカードの主効果発動前の効果発動
  // 3-c. 状態修正に起因する、スキルカードの主効果発動前の効果発動
  // 3-d. Pアイテムに起因する、n回ごとのスキルカードの主効果発動前の効果発動
  // 3-e. 主効果発動
  // 3-f. Pアイテムに起因する、スキルカードの主効果発動後の効果発動
  // 3-g. 状態修正に起因する、スキルカードの主効果発動後の効果発動
  // 3-h. Pアイテムに起因する、スキルカードの主効果による状態修正増加後の効果発動
  //
  // 仕様確認済み情報のまとめ
  //
  ...
  // - 3-b, 3-c と 3-d
  //   - 具体的には検証可能だが、未検証。ターン開始時トリガーの方で「nターンごと」が「ターン開始時」の後だったことから、それに準じて後にしている。
  //     - 仕様確認Issue: https://github.com/kjirou/gakumas-core/issues/240
  // - 3-f と 3-g の順序
  //   - どちらもキャラ固有にしか存在しなく、同時に所持できないので不明
  //   - Ref: https://github.com/kjirou/gakumas-core/issues/224
  // - 3-f と 3-h の順序
  //   - どちらもキャラ固有にしか存在しなく、同時に所持できないので不明
  //
